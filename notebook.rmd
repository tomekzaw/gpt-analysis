...
stop_delays$stopName = factor(stop_delays$stopName, levels=levels(reorder(test$stopName, test$stopSequence)))
```
...
ggplot(avgDelay, aes(as.integer(theoretical_time), stopName)) +
  ...
  labs(title="Średnie opóźnienie linii 2 na przestrzeni dnia", x="Godzina", y="Przystanek", fill="Opóźnienie") +
